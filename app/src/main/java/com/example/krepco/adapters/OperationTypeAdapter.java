...
public class OperationTypeAdapter extends ArrayAdapter<OperationType> {

    public OperationTypeAdapter(Context context, OperationType[] types) {
    ...
    private View createView(int position, View convertView, ViewGroup parent) {
        ...
        OperationType type = getItem(position);
